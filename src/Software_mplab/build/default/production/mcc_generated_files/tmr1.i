...
extern _Bool Apagar1, direccion1;
extern uint32_t N1, Yr1;
extern uint16_t tope1;

extern float ang2step;
uint8_t timer = 0, aux3 = 0;
uint32_t conteos = 0;
...
void TMR1_ISR(void)
{
    ...
    if( timer >= 2 ){
        ...
        if( N1 < 0 && direccion1) N1 = 359*ang2step;
        if( N1 >= 360*ang2step && !direccion1) N1 = 0;
        Yr1 += 1;
        timer = 0;
    }
}
